...
/**
 * GithubMark is GitHub's own glyph.
 *
 * It is drawn here rather than imported because Lucide dropped brand icons,
 * and every other icon on this page comes from Lucide. Pulling in a second
 * icon package for one path would cost more than the path does.
 */
